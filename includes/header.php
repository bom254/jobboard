        ...
        <div class="row align-items-center">
          ...
          <div class="right-cta-menu text-right d-flex aligin-items-center col-6">
            <div class="ml-auto">
              ...
              <a href="<?php echo APPURL; ?>/auth/register.php" class="btn btn-primary border-width-2 d-none d-lg-inline-block m-20 p-20"><span class="mr-2 icon-lock_outline"></span>Register</a>
